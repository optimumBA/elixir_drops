defmodule ElixirDropsWeb.UserAuth do
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_elixir_drops_web_user_remember_me"
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      ElixirDropsWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  Or use the `live_session` of your router to invoke the on_mount callback:
      ...
      live_session :authenticated, on_mount: [{ElixirDropsWeb.UserAuth, :ensure_authenticated}] do
