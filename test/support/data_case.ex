defmodule ElixirDrops.DataCase do
  @moduledoc """
  ...
  by setting `use ElixirDrops.DataCase, async: true`, although
  ...
  def setup_sandbox(tags) do
    pid = Sandbox.start_owner!(ElixirDrops.Repo, shared: not tags[:async])
