...
Mox.defmock(ElixirDrops.WallabyAdapter.Mock, for: ElixirDrops.WallabyAdapter)
Application.put_env(:elixir_drops, :wallaby_adapter, ElixirDrops.WallabyAdapter.Mock)
