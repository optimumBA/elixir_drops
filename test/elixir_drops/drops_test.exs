defmodule ElixirDrops.DropsTest do
  ...
  describe "broadcast_drop_creation/1" do
    test "broadcasts a message indicating that a new drop has been created" do
      ...
      assert :ok == Drops.broadcast_drop_creation(drop)
      assert_receive {Drops, [:drop, :created], ^drop}
    end
  end
  ...
  describe "broadcast_drop_screenshot_started/1" do
    test "broadcasts a message indicating that a drop screenshot is being generated" do
      ...
      assert :ok == Drops.broadcast_drop_screenshot_started(drop)
      assert_receive {Drops, [:drop, :screenshot_generation_started], ^drop}
    end
  end
  ...
  describe "broadcast_drop_screenshot_completion/2" do
    test "broadcasts a message indicating that a drop screenshot has been generated" do
      ...
      assert :ok == Drops.broadcast_drop_screenshot_completion(drop, 100, :completed)

      assert_receive {Drops, [:drop, :screenshot_generation_completion], ^drop, 100, :completed,
                      %{action: "new"}}
    end
  end
