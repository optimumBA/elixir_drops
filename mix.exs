defmodule ElixirDrops.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      # CI
      dialyzer: [
        plt_add_apps: [:ex_unit, :mix, :phoenix_test_playwright],
      ...
      # Docs
      name: "ElixirDrops",
      source_url: "https://github.com/optimumBA/elixir_drops",
      docs: [
        extras: ["README.md"],
        main: "readme",
        source_ref: "main"
